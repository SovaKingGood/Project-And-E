...
#define LVGL_TASK_STACK_SIZE    6144        /* 6KB - aggressive saving */
...
/* =============================== UI/Label update =============================== */
#define LABEL_UPDATE_TASK_PRIORITY  1           /* Lowest priority - just UI display */
#define LABEL_UPDATE_TASK_STACK     2048
